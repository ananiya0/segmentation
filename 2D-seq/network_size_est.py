...
class Concatonate(nn.Module):

    def __init__(self, axis):
        super(Concatonate, self).__init__()
        self.axis = axis

    def forward(input1, input2):

        return torch.cat([input1, input2])
